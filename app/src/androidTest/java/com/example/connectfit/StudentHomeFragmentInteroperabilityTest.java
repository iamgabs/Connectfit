...
public class StudentHomeFragmentInteroperabilityTest {
    ...
    @Test
    public void givenAnUser_whenLoggingSuccessfully_thenVerifyActionAtHomeFragmentToMyProfessionals() {
        ...
        try {
            // Perform action to navigate to myProfessionals
    ...
    @Test
    public void givenAnUser_whenLoggingSuccessfully_thenVerifyActionAtHomeFragmentToSearchFragment() {
        onView(withId(R.id.changeScreenFromLoginToSignin)).perform(click());
        onView(withId(R.id.changeScreenFromSigninToLogin)).perform(click());
        onView(withId(R.id.email)).perform(typeText(user.getEmail()));
        onView(withId(R.id.password)).perform(typeText(user.getPassword()));
        ...
        try {
            // Perform action to navigate to SearchFragment
