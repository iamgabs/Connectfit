...
public class ListStudentsFragmentInteroperabilityTest {
    ...
    @Test
    public void givenAnUser_whenLoggingSuccessfully_thenVerifyActionAtListStudentsFragmentResultsFoundSuccessfully() {
        ...
        try {
            // Perform action to verify if list view was updated with the students list
            onView(withText("ateste"))
